...
var products = [
    {name:"Momo Neo R21",price:1500,img:"img/product/alloy1.png"},
    {name:"Momo Spider R19",price:1100,img:"img/product/alloy2.png"},
    {name:"Momo RF-02 R21",price:1300,img:"img/product/alloy3.png"},
    {name:"Mitsubishi Lancer Turbo",price:3300,img:"img/product/turbo1.png"},
    {name:"BL-5855 Dual Ball Bearing Billet Turbocharger",price:2500,img:"img/product/turbo2.png"},
    {name:"VTEC sticker",price:15,img:"img/product/sticker1.png"},
    {name:"Drift sticker",price:15,img:"img/product/sticker2.jpg"},
    {name:"Flame Venyl",price:200,img:"img/product/venyl1.png"},
    {name:"Brambo Break Combo",price:2000,img:"img/product/break1.png"}
];
...
function createProducts(){
   ...
   for(i=0;i<products.length;i++){
        ...
        var item = "<div class='col-xs-12 col-sm-4'><div class='carbox'><a class='img-carbox' href=''><img style='width: 65%;margin-left: 50px; ' src='"+products[i].img+"' /></a><div class='carbox-content'><h4 class='carbox-title'><span>"+products[i].name+"</span></h4><p class=''>CAD$ <span>"+products[i].price+"</span></p></div><div><a id="+i+" class='abc btn btn-primary btn-block addToCart'>Add To Cart</a></div></div></div>";
